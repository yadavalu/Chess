...
# Project:  Chess.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Chess.pro
#############################################################################
...
INCPATH       = -I. -I. -IGraphics -IUI -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = chess1.0.0
DISTDIR = /mnt/Games/Chess/.tmp/chess1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lsfml-window -lsfml-system -lsfml-graphics /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Chess.pro enumerate.hh \
		Graphics/board.hh \
		Graphics/piece.hh \
		Graphics/pieces.hh \
		Graphics/places.hh \
		UI/options.hh main.cc \
		Graphics/board.cc \
		Graphics/piece.cc \
		Graphics/pieces.cc \
		Graphics/places.cc \
...
Makefile: Chess.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents enumerate.hh Graphics/board.hh Graphics/piece.hh Graphics/pieces.hh Graphics/places.hh UI/options.hh $(DISTDIR)/
	$(COPY_FILE) --parents main.cc Graphics/board.cc Graphics/piece.cc Graphics/pieces.cc Graphics/places.cc UI/options.cc $(DISTDIR)/
...
main.o: main.cc Graphics/board.hh \
		Graphics/pieces.hh \
		Graphics/piece.hh \
		Graphics/places.hh \
		enumerate.hh
...
board.o: Graphics/board.cc Graphics/board.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o board.o Graphics/board.cc

piece.o: Graphics/piece.cc Graphics/piece.hh \
		Graphics/places.hh \
		enumerate.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o piece.o Graphics/piece.cc

pieces.o: Graphics/pieces.cc Graphics/pieces.hh \
		Graphics/piece.hh \
		enumerate.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pieces.o Graphics/pieces.cc

places.o: Graphics/places.cc Graphics/places.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o places.o Graphics/places.cc

options.o: UI/options.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o options.o UI/options.cc
