...
std::string GetNotes(sf::Vector2i locations)
{
    ...
    if (std::floor(locations.x/100)*100 == PA) ret += 'A';
    else if (std::floor(locations.x/100)*100 == PB) ret += 'B';
    else if (std::floor(locations.x/100)*100 == PC) ret += 'C';
    else if (std::floor(locations.x/100)*100 == PD) ret += 'D';
    else if (std::floor(locations.x/100)*100 == PE) ret += 'E';
    else if (std::floor(locations.x/100)*100 == PF) ret += 'F';
    else if (std::floor(locations.x/100)*100 == PG) ret += 'G';
    else if (std::floor(locations.x/100)*100 == PH) ret += 'H';

    if (std::floor(locations.y/100)*100 == N1) ret += '1';
    else if (std::floor(locations.y/100)*100 == N2) ret += '2';
    else if (std::floor(locations.y/100)*100 == N3) ret += '3';
    else if (std::floor(locations.y/100)*100 == N4) ret += '4';
    else if (std::floor(locations.y/100)*100 == N5) ret += '5';
    else if (std::floor(locations.y/100)*100 == N6) ret += '6';
    else if (std::floor(locations.y/100)*100 == N7) ret += '7';
    else if (std::floor(locations.y/100)*100 == N8) ret += '8';
